...
exports.get_languages = exports.mn_decode = exports.mn_encode = void 0;
...
function mn_encode(str, wordsetName = MN_DEFAULT_WORDSET) {
...
function mn_decode(str, wordsetName = MN_DEFAULT_WORDSET) {
    const wordset = mnWords[wordsetName];
    let out = '';
    const n = wordset.words.length;
