...
export class PubKey {
   ...
   */
  public static validateWithErrorNoBlinding(
    pubkey: string,
  ): string | undefined {
    // Check if it's hex
   ...
   */
  public static isValidPrefixAndLength(
    keyWithOrWithoutPrefix: string,
  ): boolean {
    return (
  ...
  public static isEqual(
    comparator1: PubKey | string,
    comparator2: PubKey | string,
  ) {
