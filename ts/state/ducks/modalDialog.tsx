...
//TODO export type ConfirmModalState = SessionConfirmDialogProps | null;
...
//TODO export type SessionPasswordModalState = { passwordAction: PasswordAction; onOk: () => void } | null;
export type SessionPasswordModalState = null
...
const ModalSlice = createSlice({
  ...
  reducers: {
    ...
    updateInviteContactModal(
      state,
      action: PayloadAction<InviteContactModalState | null>,
    ) {
    ...
    updateGroupNameModal(
      state,
      action: PayloadAction<UpdateGroupNameModalState | null>,
    ) {
      return { ...state, groupNameModal: action.payload }
    },
    updateGroupMembersModal(
      state,
      action: PayloadAction<UpdateGroupMembersModalState | null>,
    ) {
      return { ...state, groupMembersModal: action.payload }
    },
    updateUserDetailsModal(
      state,
      action: PayloadAction<UserDetailsModalState | null>,
    ) {
      return { ...state, userDetailsModal: action.payload }
    },
    changeNickNameModal(
      state,
      action: PayloadAction<ChangeNickNameModalState | null>,
    ) {
      return { ...state, nickNameModal: action.payload }
    },
    editProfileModal(
      state,
      action: PayloadAction<EditProfileModalState | null>,
    ) {
    ...
    recoveryPhraseModal(
      state,
      action: PayloadAction<RecoveryPhraseModalState | null>,
    ) {
    ...
    updateDeleteAccountModal(
      state,
      action: PayloadAction<DeleteAccountModalState>,
    ) {
