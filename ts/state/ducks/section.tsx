...
type FocusSettingsSectionActionType = {
  ...
  //TODO payload: SessionSettingCategory;
  payload: {}
}
...
export function showSettingsSection(
  //TODO category: SessionSettingCategory
  category: {},
): FocusSettingsSectionActionType {
  return {
    type: FOCUS_SETTINGS_SECTION,
...
export type SectionStateType = {
  ...
  //TODO focusedSettingsSection?: SessionSettingCategory;
  ...
  switch (type) {
    case FOCUS_SECTION:
      ...
      return {
        ...
        //TODO focusedSettingsSection: SessionSettingCategory.Privacy,
        focusedSettingsSection: {},
      }
