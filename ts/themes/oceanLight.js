...
exports.oceanLight = void 0;
const hexColorToRGB_1 = require("../util/hexColorToRGB");
const colors_1 = require("./constants/colors");
exports.oceanLight = {
    '--danger-color': colors_1.THEMES.OCEAN_LIGHT.DANGER,
    '--disabled-color': colors_1.THEMES.OCEAN_LIGHT.DISABLED,
    '--background-primary-color': colors_1.THEMES.OCEAN_LIGHT.COLOR7,
    '--background-secondary-color': colors_1.THEMES.OCEAN_LIGHT.COLOR6,
    '--text-primary-color': colors_1.THEMES.OCEAN_LIGHT.COLOR1,
    '--text-secondary-color': colors_1.THEMES.OCEAN_LIGHT.COLOR2,
    '--text-selection-color': `rgba(${(0, hexColorToRGB_1.hexColorToRGB)(colors_1.THEMES.OCEAN_LIGHT.COLOR1)}, 0.5)`,
    '--border-color': colors_1.THEMES.OCEAN_LIGHT.COLOR3,
    ...
    '--message-bubbles-received-background-color': colors_1.THEMES.OCEAN_LIGHT.COLOR4,
    ...
    '--menu-button-background-hover-color': colors_1.THEMES.OCEAN_LIGHT.COLOR3,
    '--menu-button-icon-color': colors_1.THEMES.OCEAN_LIGHT.COLOR1,
    '--chat-buttons-background-color': colors_1.THEMES.OCEAN_LIGHT.COLOR5,
    '--chat-buttons-background-hover-color': colors_1.THEMES.OCEAN_LIGHT.COLOR3,
    '--chat-buttons-icon-color': 'var(--text-primary-color)',
    '--settings-tab-background-color': 'var(--background-primary-color)',
    '--settings-tab-background-hover-color': colors_1.THEMES.OCEAN_LIGHT.COLOR6,
    '--settings-tab-background-selected-color': colors_1.THEMES.OCEAN_LIGHT.COLOR5,
    '--settings-tab-text-color': 'var(--text-primary-color)',
    '--button-outline-background-color': 'var(--transparent-color)',
    '--button-outline-background-hover-color': `rgba(${(0, hexColorToRGB_1.hexColorToRGB)(colors_1.THEMES.OCEAN_LIGHT.COLOR0)}, 0.1)`,
    ...
    '--button-solid-background-hover-color': colors_1.THEMES.OCEAN_LIGHT.COLOR6,
    '--button-solid-text-color': 'var(--text-primary-color)',
    '--button-solid-text-hover-color': 'var(--text-primary-color)',
    '--button-solid-disabled-color': colors_1.THEMES.OCEAN_LIGHT.COLOR4,
    '--button-solid-shadow-color': `rgba(${(0, hexColorToRGB_1.hexColorToRGB)(colors_1.THEMES.OCEAN_LIGHT.COLOR0)}, 0.25)`,
    ...
    '--conversation-tab-background-hover-color': colors_1.THEMES.OCEAN_LIGHT.COLOR5,
    '--conversation-tab-background-selected-color': colors_1.THEMES.OCEAN_LIGHT.COLOR5,
    ...
    '--search-bar-background-color': colors_1.THEMES.OCEAN_LIGHT.COLOR5,
    ...
    '--scroll-bar-thumb-color': colors_1.THEMES.OCEAN_LIGHT.COLOR4,
    '--scroll-bar-thumb-hover-color': colors_1.THEMES.OCEAN_LIGHT.COLOR3,
    '--zoom-bar-track-color': colors_1.THEMES.OCEAN_LIGHT.COLOR4,
    ...
    '--unread-messages-alert-text-color': colors_1.THEMES.OCEAN_LIGHT.COLOR0,
    ...
    '--right-panel-item-background-hover-color': colors_1.THEMES.OCEAN_LIGHT.COLOR4,
    ...
    '--suggestions-background-hover-color': colors_1.THEMES.OCEAN_LIGHT.COLOR4,
    ...
    '--call-buttons-background-color': colors_1.THEMES.OCEAN_LIGHT.COLOR4,
    '--call-buttons-background-hover-color': colors_1.THEMES.OCEAN_LIGHT.COLOR4,
    '--call-buttons-background-disabled-color': colors_1.THEMES.OCEAN_LIGHT.COLOR5,
    '--call-buttons-action-background-color': colors_1.THEMES.OCEAN_LIGHT.COLOR4,
    '--call-buttons-action-background-hover-color': colors_1.THEMES.OCEAN_LIGHT.COLOR5,
