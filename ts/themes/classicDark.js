...
exports.classicDark = {
    '--danger-color': colors_1.THEMES.CLASSIC_DARK.DANGER,
    '--disabled-color': colors_1.THEMES.CLASSIC_DARK.DISABLED,
    '--background-primary-color': colors_1.THEMES.CLASSIC_DARK.COLOR1,
    '--background-secondary-color': colors_1.THEMES.CLASSIC_DARK.COLOR0,
    '--text-primary-color': colors_1.THEMES.CLASSIC_DARK.COLOR6,
    '--text-secondary-color': colors_1.THEMES.CLASSIC_DARK.COLOR5,
    '--text-selection-color': `rgba(${(0, hexColorToRGB_1.hexColorToRGB)(colors_1.THEMES.CLASSIC_DARK.COLOR6)}, 0.5)`,
    '--border-color': colors_1.THEMES.CLASSIC_DARK.COLOR3,
    ...
    '--message-bubbles-received-background-color': colors_1.THEMES.CLASSIC_DARK.COLOR2,
    ...
    '--menu-button-background-hover-color': colors_1.THEMES.CLASSIC_DARK.COLOR4,
    '--menu-button-icon-color': colors_1.THEMES.CLASSIC_DARK.COLOR6,
    '--chat-buttons-background-color': colors_1.THEMES.CLASSIC_DARK.COLOR2,
    '--chat-buttons-background-hover-color': colors_1.THEMES.CLASSIC_DARK.COLOR3,
    '--chat-buttons-icon-color': 'var(--text-primary-color)',
    '--settings-tab-background-color': 'var(--background-primary-color)',
    '--settings-tab-background-hover-color': colors_1.THEMES.CLASSIC_DARK.COLOR2,
    '--settings-tab-background-selected-color': colors_1.THEMES.CLASSIC_DARK.COLOR3,
    '--settings-tab-text-color': 'var(--text-primary-color)',
    '--button-outline-background-color': 'var(--transparent-color)',
    '--button-outline-background-hover-color': `rgba(${(0, hexColorToRGB_1.hexColorToRGB)(colors_1.THEMES.CLASSIC_DARK.COLOR6)}, 0.3)`,
    ...
    '--button-solid-background-color': colors_1.THEMES.CLASSIC_DARK.COLOR3,
    '--button-solid-background-hover-color': colors_1.THEMES.CLASSIC_DARK.COLOR4,
    '--button-solid-text-color': 'var(--text-primary-color)',
    '--button-solid-text-hover-color': 'var(--text-primary-color)',
    '--button-solid-disabled-color': colors_1.THEMES.CLASSIC_DARK.COLOR4,
    ...
    '--conversation-tab-background-hover-color': colors_1.THEMES.CLASSIC_DARK.COLOR3,
    '--conversation-tab-background-selected-color': colors_1.THEMES.CLASSIC_DARK.COLOR3,
    '--conversation-tab-background-unread-color': colors_1.THEMES.CLASSIC_DARK.COLOR2,
    ...
    '--conversation-tab-bubble-background-color': colors_1.THEMES.CLASSIC_DARK.COLOR3,
    ...
    '--scroll-bar-thumb-color': colors_1.THEMES.CLASSIC_DARK.COLOR3,
    '--scroll-bar-thumb-hover-color': colors_1.THEMES.CLASSIC_DARK.COLOR4,
    '--zoom-bar-track-color': colors_1.THEMES.CLASSIC_DARK.COLOR3,
    ...
    '--unread-messages-alert-text-color': colors_1.THEMES.CLASSIC_DARK.COLOR0,
    ...
    '--emoji-reaction-bar-background-color': colors_1.THEMES.CLASSIC_DARK.COLOR2,
    ...
    '--right-panel-item-background-color': colors_1.THEMES.CLASSIC_DARK.COLOR2,
    '--right-panel-item-background-hover-color': colors_1.THEMES.CLASSIC_DARK.COLOR3,
    ...
    '--suggestions-background-color': colors_1.THEMES.CLASSIC_DARK.COLOR2,
    '--suggestions-background-hover-color': colors_1.THEMES.CLASSIC_DARK.COLOR3,
    ...
    '--call-buttons-background-color': colors_1.THEMES.CLASSIC_DARK.COLOR3,
    '--call-buttons-background-hover-color': colors_1.THEMES.CLASSIC_DARK.COLOR4,
    '--call-buttons-background-disabled-color': colors_1.THEMES.CLASSIC_DARK.COLOR2,
    '--call-buttons-action-background-color': 'var(--white-color)',
    '--call-buttons-action-background-hover-color': `rgba(${(0, hexColorToRGB_1.hexColorToRGB)(colors_1.COLORS.WHITE)}, 0.87)`,
