...
exports.oceanDark = void 0;
const hexColorToRGB_1 = require("../util/hexColorToRGB");
const colors_1 = require("./constants/colors");
exports.oceanDark = {
    '--danger-color': colors_1.THEMES.OCEAN_DARK.DANGER,
    '--disabled-color': colors_1.THEMES.OCEAN_DARK.DISABLED,
    '--background-primary-color': colors_1.THEMES.OCEAN_DARK.COLOR1,
    '--background-secondary-color': colors_1.THEMES.OCEAN_DARK.COLOR2,
    '--text-primary-color': colors_1.THEMES.OCEAN_DARK.COLOR7,
    '--text-secondary-color': colors_1.THEMES.OCEAN_DARK.COLOR5,
    '--text-selection-color': `rgba(${(0, hexColorToRGB_1.hexColorToRGB)(colors_1.THEMES.OCEAN_DARK.COLOR7)}, 0.5)`,
    '--border-color': colors_1.THEMES.OCEAN_DARK.COLOR4,
    ...
    '--message-bubbles-received-background-color': colors_1.THEMES.OCEAN_DARK.COLOR4,
    '--message-bubbles-sent-text-color': colors_1.THEMES.OCEAN_DARK.COLOR0,
    '--message-bubbles-received-text-color': 'var(--text-primary-color)',
    '--menu-button-background-color': 'var(--primary-color)',
    '--menu-button-background-hover-color': colors_1.THEMES.OCEAN_DARK.COLOR6,
    '--menu-button-icon-color': colors_1.THEMES.OCEAN_DARK.COLOR7,
    '--chat-buttons-background-color': colors_1.THEMES.OCEAN_DARK.COLOR2,
    '--chat-buttons-background-hover-color': colors_1.THEMES.OCEAN_DARK.COLOR4,
    '--chat-buttons-icon-color': colors_1.THEMES.OCEAN_DARK.COLOR7,
    '--settings-tab-background-color': 'var(--background-primary-color)',
    '--settings-tab-background-hover-color': colors_1.THEMES.OCEAN_DARK.COLOR3,
    '--settings-tab-background-selected-color': colors_1.THEMES.OCEAN_DARK.COLOR3,
    '--settings-tab-text-color': 'var(--text-primary-color)',
    '--button-outline-background-color': 'var(--transparent-color)',
    '--button-outline-background-hover-color': `rgba(${(0, hexColorToRGB_1.hexColorToRGB)(colors_1.THEMES.OCEAN_DARK.COLOR7)}, 0.3)`,
    ...
    '--button-solid-background-hover-color': colors_1.THEMES.OCEAN_DARK.COLOR4,
    '--button-solid-text-color': 'var(--text-primary-color)',
    '--button-solid-text-hover-color': 'var(--text-primary-color)',
    '--button-solid-disabled-color': colors_1.THEMES.OCEAN_DARK.COLOR4,
    ...
    '--conversation-tab-background-hover-color': colors_1.THEMES.OCEAN_DARK.COLOR3,
    '--conversation-tab-background-selected-color': colors_1.THEMES.OCEAN_DARK.COLOR3,
    '--conversation-tab-background-unread-color': colors_1.THEMES.OCEAN_DARK.COLOR2,
    ...
    '--conversation-tab-bubble-text-color': colors_1.THEMES.OCEAN_DARK.COLOR0,
    '--conversation-tab-color-strip-color': 'var(--primary-color)',
    '--search-bar-background-color': colors_1.THEMES.OCEAN_DARK.COLOR3,
    ...
    '--scroll-bar-thumb-color': colors_1.THEMES.OCEAN_DARK.COLOR4,
    '--scroll-bar-thumb-hover-color': colors_1.THEMES.OCEAN_DARK.COLOR5,
    '--zoom-bar-track-color': colors_1.THEMES.OCEAN_DARK.COLOR4,
    ...
    '--unread-messages-alert-text-color': colors_1.THEMES.OCEAN_DARK.COLOR0,
    ...
    '--right-panel-item-background-hover-color': colors_1.THEMES.OCEAN_DARK.COLOR4,
    ...
    '--suggestions-background-hover-color': colors_1.THEMES.OCEAN_DARK.COLOR4,
    ...
    '--call-buttons-background-color': colors_1.THEMES.OCEAN_DARK.COLOR4,
    '--call-buttons-background-hover-color': colors_1.THEMES.OCEAN_DARK.COLOR4,
    '--call-buttons-background-disabled-color': colors_1.THEMES.OCEAN_DARK.COLOR3,
    ...
    '--call-buttons-icon-color': colors_1.THEMES.OCEAN_DARK.COLOR7,
    '--call-buttons-icon-disabled-color': colors_1.THEMES.OCEAN_DARK.COLOR7,
